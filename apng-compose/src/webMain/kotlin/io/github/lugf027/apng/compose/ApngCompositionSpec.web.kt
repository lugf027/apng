            ...
            try {
                val bytes = when (spec) {
                    ...
                    is ApngCompositionSpec.File -> {
                        throw IllegalArgumentException("File loading not supported in web environment")
                    }
                    is ApngCompositionSpec.Resource -> {
                        throw IllegalArgumentException("Resource loading not supported in web environment")
                    }
                }
